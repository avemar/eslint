...
module.exports = class Linter {
     ...
     * @param {Array} [filenameOrOptions.diffLines] Resulting lines after Git
     *      diff on which the linter is executed
    ...
    _verifyWithoutProcessors(textOrSourceCode, config, filenameOrOptions) {
        ...
        if (typeof filenameOrOptions === "object") {
            ...
            diffLines = filenameOrOptions.diffLines;
        } else {
            providedFilename = filenameOrOptions;
        }

        if (typeof diffLines === 'undefined') {
            diffLines = [];
        }
                ...
                Object.assign(
                    Object.create(sharedTraversalContext),
                    {
                        ...
                        report() {
                            ...
                            problem.isDiff = false;

                            if (diffLines.indexOf(problem.line) !== -1) {
                                problem.isDiff = true;
                            }
